...
FactoryBot.define do
  ...
  factory :question, class: "Decidim::Questions::Question" do
    ...
    trait :with_endorsements do
      after :create do |question|
        5.times.collect do
          create(:endorsement, resource: question, author: build(:user, organization: question.participatory_space.organization))
        end
      end
    end
    ...
    trait :with_amendments do
      after :create do |question|
        create_list(:question_amendment, 5, amendable: question)
      end
    end
  end
  ...
  factory :question_amendment, class: "Decidim::Amendment" do
    amendable { build(:question) }
    emendation { build(:question, component: amendable.component) }
  ...
  factory :valuation_assignment, class: "Decidim::Questions::ValuationAssignment" do
    question
    valuator_role do
      space = question.component.participatory_space
