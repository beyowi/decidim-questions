  ...
  module Questions
    ...
    class HighlightedQuestionsForComponentCell < Decidim::ViewModel
      ...
      def questions_to_render
        @questions_to_render ||= questions.includes([:amendable, :category, :component, :scope]).limit(Decidim::Questions.config.participatory_space_highlighted_questions_limit)
      end
