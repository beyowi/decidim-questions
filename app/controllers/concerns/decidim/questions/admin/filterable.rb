    ...
    module Admin
      module Filterable
        ...
        included do
          ...
          helper Decidim::Questions::Admin::FilterableHelper
          ...
          def base_query
            ...
            accessible_questions_collection
          end

          def accessible_questions_collection
          ...
          # Decidim::Questions::Admin::FilterableHelper#extra_dropdown_submenu_options_items
          def question_states
            Question::POSSIBLE_STATES.without("not_answered")
          end
        end
      end
    end
