...
describe Decidim::Questions::QuestionMentionedEvent do
  ...
  let(:source_question) { create :question, component: create(:question_component, organization: organization), title: "Question A" }
  let(:mentioned_question) { create :question, component: create(:question_component, organization: organization), title: "Question B" }
  ...
  context "with content" do
    ...
    describe "email_intro" do
      let(:resource_url) { resource_locator(source_question).url }
    ...
    describe "notification_title" do
      let(:resource_url) { resource_locator(source_question).path }
