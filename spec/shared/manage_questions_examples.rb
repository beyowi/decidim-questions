...
shared_examples "manage questions" do
        ...
        context "when process is not related to any scope" do
          ...
          it "creates a new question", :slow do
            ...
            within ".new_question" do
              ...
              fill_in_editor :question_body, with: "Decidim is great but it can be better"
            ...
            within "table" do
              ...
              expect(question.body).to eq("<p>Decidim is great but it can be better</p>")
        ...
        context "when attachments are allowed", processing_uploads_for: Decidim::AttachmentUploader do
          ...
          it "creates a new question with attachments" do
            ...
            within ".new_question" do
              ...
              fill_in_editor :question_body, with: "This is my question and I want to upload attachments."
        ...
        context "when questions comes from a meeting" do
          ...
          it "creates a new question with meeting as author" do
            ...
            within ".new_question" do
              ...
              fill_in_editor :question_body, with: "Question body of meeting as author"
            ...
            within "table" do
              ...
              expect(question.body).to eq("<p>Question body of meeting as author</p>")
              expect(question.category).to eq(category)
            end
          end
        end
  ...
  context "when the question_answering component setting is enabled" do
    ...
    context "when the question_answering step setting is enabled" do
      ...
      it "can reject a question" do
        go_to_admin_question_page_answer_section(question)
  ...
  context "when the question_answering component setting is disabled" do
    ...
    it "cannot answer a question" do
      ...
      expect(page).to have_no_selector(".edit_question_answer")
    end
  end
  ...
  def go_to_admin_question_page_answer_section(question)
    go_to_admin_question_page(question)
