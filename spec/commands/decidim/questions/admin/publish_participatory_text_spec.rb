    ...
    module Admin
      describe PublishParticipatoryText do
        describe "call" do
          ...
          let(:questions) do
            questions = create_list(:question, 3, :draft, component: current_component)
          ...
          it "creates a version for each question", versioning: true do
            expect { command.call }.to broadcast(:ok)

            questions.each do |question|
              expect(question.reload.versions.count).to eq(1)
            end
          end
