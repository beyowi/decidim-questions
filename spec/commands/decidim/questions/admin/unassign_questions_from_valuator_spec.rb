...
module Decidim
  module Questions
    module Admin
      describe UnassignQuestionsFromValuator do
        describe "call" do
          ...
          let(:form) do
            instance_double(
              ...
              questions: [assigned_question, unassigned_question],
              valid?: valid
            )
          end
          ...
          describe "when the form is valid" do
            ...
            it "destroys the valuation assignment between the user and the question" do
              expect do
                command.call
            ...
            it "traces the action", versioning: true do
              expect(Decidim.traceability)
                ...
                .with(:delete, assignment, form.current_user, question_title: assigned_question.title)
                .and_call_original
