...
require "decidim/core/test/shared_examples/amendable_questions_interface_examples"
...
module Decidim
  module Questions
    describe QuestionType, type: :graphql do
      ...
      let(:model) { create(:question, :with_votes, :with_endorsements, :with_amendments, component: component) }
      ...
      include_examples "amendable questions interface"
      ...
      describe "participatory_text_level" do
        ...
        it "returns the participatory_text_level of this question" do
      ...
      describe "position" do
        ...
        it "returns the position of this question" do
      ...
      describe "created_in_meeting" do
        ...
        it "returns the created_in_meeting of this question" do
      ...
      describe "meeting" do
        ...
        let(:model) { create(:question, :official_meeting, component: component) }

        it "returns the meeting of this question" do
