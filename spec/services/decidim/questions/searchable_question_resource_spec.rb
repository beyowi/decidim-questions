...
module Decidim
  describe Search do
    ...
    let(:current_component) { create :question_component, organization: organization }
    let!(:question) do
      create(
        :question,
        :draft,
      ...
      context "when implementing Searchable" do
        ...
        context "when on update" do
          ...
          context "when it IS published" do
            ...
            it "removes the associated SearchableResource after unpublishing a published Question on update" do
    ...
    def expected_searchable_resource_attrs(question, locale)
      {
        "content_a" => I18n.transliterate(question.title),
        "content_b" => "",
        "content_c" => "",
        "content_d" => I18n.transliterate(question.body),
        "locale" => locale,
