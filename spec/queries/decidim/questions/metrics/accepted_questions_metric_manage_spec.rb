...
describe Decidim::Questions::Metrics::AcceptedQuestionsMetricManage do
  ...
  let!(:accepted_questions) { create_list(:question, 3, :accepted, created_at: day, component: component) }
  let!(:not_accepted_questions) { create_list(:question, 3, created_at: day, component: component) }
