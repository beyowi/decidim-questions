...
describe "Amendment Diff", versioning: true, type: :system do
  ...
  let!(:question) { create(:question, title: "Original long enough title", body: "Original one liner body", component: component) }
  # The first version of the emendation should hold the original question attribute values being amended.
  let!(:emendation) { create(:question, title: question.title, body: question.body, component: component) }
  ...
  context "when visiting an amendment to a question" do
    context "and the amendment is being evaluated" do
      before do
        question.update(title: "Updated long enough title", body: "Updated one liner body")
      ...
      it "shows the changed attributes compared to the last version of the amended question" do
    ...
    context "and the amendment is NOT being evaluated" do
      ...
      it "shows the changed attributes compared to the version of the amended question at the moment of making the amendment" do
        expect(page).to have_content('Amendment to "Updated long enough title"')
    ...
    context "and the emendation and the amendable have seemingly the same body but different newline escape sequences" do
      before do
        question.update(body: "One liner body\nAmended")
        # The last version of the emendation should hold the amending attribute values.
  ...
  context "when amendment REACTION is enabled" do
    ...
    context "and the question author is reviewing an emendation to their question before accepting it" do
