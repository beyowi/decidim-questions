...
describe "Amend Question", versioning: true, type: :system do
  ...
  let!(:question) { create(:question, title: "Long enough title", component: component) }
  let!(:emendation) { create(:question, title: "Amended Long enough title", component: component) }
  ...
  let(:question_path) { Decidim::ResourceLocatorPresenter.new(question).path }

  before do
    switch_to_host(component.organization.host)
  end

  context "when visiting an amended question" do
    before do
      visit question_path
    end
  ...
  context "with amendments NOT enabled" do
    ...
    context "when amendment CREATION is enabled" do
      ...
      context "and visits an amendable question" do
        ...
        it "is NOT shown a link to Amend it" do
          expect(page).not_to have_link("Amend Question")
        end
      end
    end
    ...
    context "when amendment REACTION is enabled" do
      ...
      context "and the question author visits an emendation to their question" do
    ...
    context "when amendment PROMOTION is enabled" do
      ...
      context "and the author of a rejected emendation visits their emendation" do
        ...
        it "is NOT shown the promote button" do
          ...
          expect(page).not_to have_content("You can promote this emendation and publish it as an independent question")
        end
      end
    end
    ...
    context "when amendments VISIBILITY is set to 'participants'" do
      ...
      context "when the user is logged in" do
        ...
        context "and visit an amendable question that they have amended" do
          let(:user) { emendation.creator_author }
        ...
        context "and visit an amendable question that they have NOT amended" do
      ...
      context "when the user is NOT logged in" do
        ...
        context "and visit an amendable question" do
          it "is shown the emendation from other users in the amendments list" do
            within ".amendment-list" do
              expect(page).to have_content(emendation.title)
            end
  ...
  context "with amendments enabled" do
    ...
    context "when amendment CREATION is enabled" do
      ...
      context "and visits an amendable question from a private yet transparent space" do
    ...
    context "when amendment REACTION is enabled" do
      ...
      context "and the question author visits an emendation to their question" do
        ...
        context "when the user clicks on the accept button" do
          ...
          context "and the emendation is accepted" do
            ...
            it "is changed the state of the emendation" do
              expect(page).to have_css(".success", text: "This amendment for the question #{emendation.title} has been accepted")
            end
          end
        end
        ...
        context "when the user clicks on the reject button" do
          ...
          it "is changed the state of the emendation" do
            expect(page).to have_css(".callout.alert", text: "This amendment for the question #{question.title} was rejected")
          end
        end
      end
    end
    ...
    context "when amendment PROMOTION is enabled" do
      ...
      context "and the author of a rejected emendation visits their emendation" do
        ...
        it "is shown the promote button" do
          ...
          expect(page).to have_content("You can promote this emendation and publish it as an independent question")
        end
        ...
        context "when the user clicks on the promote button" do
          ...
          it "is shown the Success Callout when the alert text is accepted" do
            accept_confirm
            expect(page).to have_content("The amendment has been successfully published as a new question")
          end
