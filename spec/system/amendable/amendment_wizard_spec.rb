...
describe "Amendment Wizard", type: :system do
  ...
  let!(:question) { create(:question, title: "More roads and less sidewalks", component: component) }
  ...
  context "when amending a question" do
    before do
    ...
    context "and in step_1: Create your amendment" do
      ...
      context "when the back button is clicked" do
        ...
        it "redirects to the question page" do
          ...
          expect(page).to have_content("AMEND QUESTION")
        end
      end
    end
    ...
    context "and in step_2: Compare your amendment" do
      context "with similar results" do
        let!(:emendation) { create(:question, title: title, body: body, component: component) }
    ...
    context "and in step_4: Publish your amendment" do
      ...
      context "when the Publish button is clicked", versioning: true do
        ...
        it "publishes the amendment" do
          expect(page).to have_css(".callout.warning", text: "This amendment for the question #{question.title} is being evaluated.")
  ...
  context "with existing amendment drafts" do
    ...
    let!(:amendment) { create :amendment, amendable: question, emendation: emendation }
    let!(:emendation_draft) { create(:question, :unpublished, component: component) }
    let!(:amendment_draft) { create :amendment, :draft, amendable: question, emendation: emendation_draft }

    context "and visiting an amended question" do
      before do
        visit question_path
      end
