...
describe "Question", type: :system do
  ...
  context "when creating a new question" do
    ...
    context "when in step_1: Create your question" do
    ...
    context "when in step_2: Compare" do
      context "with similar results" do
        ...
        it "shows similar questions" do
          expect(page).to have_content("SIMILAR QUESTIONS (2)")
    ...
    context "when in step_3: Complete" do
      ...
      context "when the back button is clicked" do
        before do
          create(:question, title: question_title, component: component)
          click_link "Back"
        end

        it "redirects to step_3: complete" do
          expect(page).to have_content("SIMILAR QUESTIONS (1)")
        end
      end
    end
    ...
    context "when in step_4: Publish" do
      ...
      before do
        visit component_path.preview_question_path(question_draft)
      end
      ...
      context "when the back button is clicked" do
        ...
        it "redirects to edit the question draft" do
          expect(page).to have_content("EDIT QUESTION DRAFT")
        end
      end
    end
